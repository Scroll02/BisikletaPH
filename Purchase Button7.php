...
<p><h1><center>Thank You for purchasing here at BISIKLETA PH!</h1></p>
<center>
<img src="images/cerveloorange.jpg" alt="Forest" widht="500" height="500">
         
        <aside id="sidebar">
          <div class="dark">
            <h4>₱2,500</h4>
			<h1>Cervelo Orange Bike Part</h1>
            <form class="quote">
