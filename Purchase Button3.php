...
<p><h1><center>Thank You for purchasing Kid/Children's Bike here at BISIKLETA PH!</h1></p>
<center>
<img src="images/Kbike.jpg" alt="Forest" widht="500" height="500">
         
        <aside id="sidebar">
          <div class="dark">
            <h4>₱1,500</h4>
			<h1>Kid/Children's Bike</h1>
            <form class="quote">
  						...
  						<br>
  						<button class="button_1" type="submit" href="products.php">Checkout</button>
					</form>
          </div>
        </aside>
		</center>
<p><h2><center>have fun with your bike :)</h2></p>
<p><center>(Click home if you want to look more affordable bikes<3)</p>
